...
public class Rlogin extends javax.swing.JFrame {
    ...
    public Rlogin() {
        initComponents();
        ImageIcon imageIcon = new ImageIcon(new ImageIcon(f+"\\Image\\user1.png").getImage().getScaledInstance(50,50, Image.SCALE_SMOOTH));
        lblid.setIcon(imageIcon);
        ImageIcon imageIcon1 = new ImageIcon(new ImageIcon(f+"\\Image\\p1.png").getImage().getScaledInstance(49,50, Image.SCALE_SMOOTH));
        lblp.setIcon(imageIcon1);
        ImageIcon imageIcon2 = new ImageIcon(new ImageIcon(f+"\\Image\\icon.png").getImage().getScaledInstance(260,220, Image.SCALE_SMOOTH));
            ...
            try {
                ...
                try {
                    for(int i=0;i<ln;i+=5){ //if have 5 line for 1 user put 5,6 put 6
                         ...
                         * System.out.println(admin1.getP()); for debugging*/
